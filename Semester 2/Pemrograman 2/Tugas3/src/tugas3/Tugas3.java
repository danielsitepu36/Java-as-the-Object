                    ...
                    case "C":
                        ...
                        if (kontak.find(query)) {
                            ...
                            do {
                                ...
                                System.out.println("E) Kembali ke menu");
                                System.out.print("Masukkan pilihan (A/B/C/D/E) : ");
                                fitur = input.next();
                                System.out.println();
                                switch (fitur) {
                                    case "A":
                                    ...
                                    case "E":
                                        break;
                                    default:
                                        System.out.println("ERROR, harap masukkan pilihan (A/B/C/D/E) !");
                                        break;
                                }
                            } while (!"E".equals(fitur));
                        } else {
                            System.out.println("Data tidak ditemukan !");
                        }
                        System.out.println();
